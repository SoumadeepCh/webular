...
export default function EnhancedSqlQuestionsPage() {
        ...
        var fetchQuestions = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch("/api/questions?category=sql")];
                    case 1:
                        response = _a.sent();
    ...
    var getSqlSuggestions = function (difficulty) {
        var suggestions = {
            easy: [
                "SELECT",
                "FROM",
                    ...
                    : level === "medium"
                        ...
                        : "bg-red-500")}></div>
								...
								<div className="grid grid-cols-1 gap-2">
									{getSqlSuggestions(level).map(function (concept, idx) { return (<div key={idx} className="bg-gray-50 rounded-lg p-3 hover:bg-gray-100 transition-colors duration-200 cursor-pointer group">
