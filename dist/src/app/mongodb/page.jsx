...
export default function EnhancedMongodbQuestionsPage() {
        ...
        var fetchQuestions = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch("/api/questions?category=mongodb")];
                    case 1:
                        response = _a.sent();
    ...
    var getMongoSuggestions = function (difficulty) {
        var suggestions = {
            easy: [
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
                    ...
                    : level === "medium"
                        ...
                        : "bg-red-500")}></div>
								...
								<div className="grid grid-cols-1 gap-2">
									{getMongoSuggestions(level).map(function (concept, idx) { return (<div key={idx} className="bg-gray-50 rounded-lg p-3 hover:bg-gray-100 transition-colors duration-200 cursor-pointer group">
			...
			<div className="container mx-auto px-6 py-8">
                ...
                return setHoveredCard(question._id);
            }} onMouseLeave={function () { return setHoveredCard(null); }}>
                ...
                hoveredCard === question._id && (<div className="mb-4 p-3 bg-gray-50 rounded-lg border">
												...
												<div className="grid grid-cols-2 gap-2">
													{question.mongoConcepts
                    .slice(0, 4)
                    .map(function (concept, idx) { return (<code key={idx} className="text-xs bg-white px-2 py-1 rounded border text-blue-600">
																{concept}
															</code>); })}
												</div>
											</div>)}
