...
export default function EnhancedCssQuestionsPage() {
        ...
        var fetchQuestions = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch("/api/questions?category=css")];
                    case 1:
                        response = _a.sent();
    ...
    var getCssSuggestions = function (difficulty) {
        var suggestions = {
            easy: [
                "color",
                "background-color",
                    ...
                    : level === "medium"
                        ...
                        : "bg-red-500")}></div>
								...
								<div className="grid grid-cols-1 gap-2">
									{getCssSuggestions(level).map(function (property, index) { return (<div key={index} className="bg-gray-50 rounded-lg p-3 hover:bg-gray-100 transition-colors duration-200 cursor-pointer group">
