...
const sampleQuestions = [
  // CSS Questions
  {
    ...
    description: "Create a responsive grid layout that adapts to different screen sizes using CSS Grid properties.",
    category: "css",
    difficulty: "medium",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Design a smooth, rotating loading spinner using CSS animations and keyframes.",
    category: "css",
    difficulty: "easy",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Build a complex navigation bar with dropdown menus using advanced Flexbox techniques.",
    category: "css",
    difficulty: "hard",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Implement a dark/light theme system using CSS custom properties and JavaScript.",
    category: "css",
    difficulty: "medium",
    testCases: [],
    image: "",
...
`
  ...
  // HTML Questions
  {
    ...
    description: "Explain the basic structure of an HTML document, including doctype, html, head, and body tags.",
    category: "html",
    difficulty: "easy",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Discuss the importance of semantic HTML5 elements like <header>, <nav>, <article>, <section>, and <footer>.",
    category: "html",
    difficulty: "medium",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Describe various HTML form input types and their uses, including text, password, checkbox, radio, and submit.",
    category: "html",
    difficulty: "medium",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Explain how to embed images, audio, and video in HTML documents using appropriate tags and attributes.",
    category: "html",
    difficulty: "easy",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Demonstrate how to create well-structured HTML tables with headers, rows, and cells.",
    category: "html",
    difficulty: "easy",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Discuss key HTML practices for improving web accessibility, such as alt text, ARIA attributes, and proper heading structure.",
    category: "html",
    difficulty: "hard",
    testCases: [],
    image: "",
...
`
  ...
  // JavaScript Questions
  {
    ...
    description: "Explain what closures are in JavaScript and provide a practical example of their use.",
    category: "js",
    difficulty: "medium",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Compare and contrast callbacks, Promises, and async/await for handling asynchronous operations in JavaScript.",
    category: "js",
    difficulty: "hard",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Describe the concept of event delegation and explain its benefits with a code example.",
    category: "js",
    difficulty: "medium",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Explain the different contexts in which the 'this' keyword behaves in JavaScript (global, object method, constructor, explicit binding, arrow functions).",
    category: "js",
    difficulty: "hard",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Compare prototypal inheritance with class-based inheritance in JavaScript, highlighting their differences and use cases.",
    category: "js",
    difficulty: "hard",
    testCases: [],
    image: "",
...
`
  ...
  // SQL Questions
  {
    ...
    description: "Write a SQL query to select all columns from a table named 'Employees'.",
    category: "sql",
    difficulty: "easy",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Explain the different types of SQL JOINs (INNER, LEFT, RIGHT, FULL) and provide examples for each.",
    category: "sql",
    difficulty: "medium",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Describe common SQL aggregate functions (COUNT, SUM, AVG, MIN, MAX) and how to use them with GROUP BY and HAVING clauses.",
    category: "sql",
    difficulty: "medium",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Explain the concept of SQL subqueries and Common Table Expressions (CTEs), and when to use them.",
    category: "sql",
    difficulty: "hard",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Discuss the purpose of database indexing in SQL and how it can improve query performance.",
    category: "sql",
    difficulty: "hard",
    testCases: [],
    image: "",
...
`
  ...
  // MongoDB Questions
  {
    ...
    description: "Demonstrate basic CRUD operations (Create, Read, Update, Delete) in MongoDB using the `mongo` shell or a Node.js driver.",
    category: "mongodb",
    difficulty: "easy",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Use the MongoDB aggregation framework to perform data analysis, such as grouping, filtering, and calculating averages.",
    category: "mongodb",
    difficulty: "medium",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Explain the importance of indexing in MongoDB and demonstrate how to create and use indexes to optimize query performance.",
    category: "mongodb",
    difficulty: "hard",
    testCases: [],
    image: "",
...
`
  },
  {
    ...
    description: "Compare and contrast embedded and referenced document relationships in MongoDB, providing use cases and examples for each.",
    category: "mongodb",
    difficulty: "hard",
    testCases: [],
    image: "",
